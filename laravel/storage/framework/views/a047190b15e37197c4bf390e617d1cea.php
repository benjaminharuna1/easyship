...
<head>
    ...
    <title>Shipment Receipt - <?php echo e($shipment->tracking_id); ?></title>
    <style>
        :root {
            --navy: #041e42;
            --accent: #f6a400;
...
<body>
    ...
    <div class="invoice-toolbar no-print">
        <span class="tb-title">
            Shipment Receipt
            <small><?php echo e($shipment->tracking_id); ?></small>
        </span>
        ...
        <div class="invoice-body">
            ...
            <div class="invoice-head">
                <div class="brand">
                    <?php if(!empty($settings->site_logo)): ?>
                        <img src="<?php echo e(asset($settings->site_logo)); ?>" alt="<?php echo e($settings->sitename); ?>" title="<?php echo e($settings->sitename); ?>">
                    <?php endif; ?>
                    <h1><?php echo e($settings->sitename ?? ''); ?></h1>
                    <div class="site-meta">
                        <?php if(!empty($settings->site_address)): ?>
                            <?php echo nl2br(e($settings->site_address)); ?><br>
                        <?php endif; ?>
                        <?php if(!empty($settings->email_address)): ?>
                            <?php echo e($settings->email_address); ?><br>
                        <?php endif; ?>
                        <?php if(!empty($settings->site_url)): ?>
                            <a href="<?php echo e($settings->site_url); ?>"><?php echo e($settings->site_url); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="doc-title">
            ...
            <div class="parties">
                <div class="party-col">
                    ...
                    <div class="party-card">
                        <p class="party-name"><?php echo e($shipment->sender_name); ?></p>
                        <div class="detail"><span class="k">Address:</span> <?php echo e($shipment->sender_address); ?></div>
                        <div class="detail"><span class="k">Origin:</span> <?php echo e($shipment->dispatch_location); ?></div>
                    </div>
                </div>
                <div class="party-col">
                    <h3>To (Consignee)</h3>
                    <div class="party-card">
                        <p class="party-name"><?php echo e($shipment->receiver_name); ?></p>
                        <div class="detail"><span class="k">Address:</span> <?php echo e($shipment->receiver_address); ?></div>
                        <div class="detail"><span class="k">Destination:</span> <?php echo e($shipment->destination); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="meta-row">
                <div class="barcode-box">
                    ...
                    <span class="bc-number"><?php echo e($shipment->tracking_id); ?></span>
                    <small class="bc-hint">Scan to track | <?php echo e($trackingUrl); ?></small>
                </div>
                <div class="summary-box">
                    <div class="summary-row"><span class="k">Order ID</span><span class="v"><?php echo e($shipment->tracking_id); ?></span></div>
                    <div class="summary-row"><span class="k">Est. Delivery Date</span><span class="v"><?php echo e($shipment->estimated_delivery_date); ?></span></div>
                    <div class="summary-row"><span class="k">Dispatch Date</span><span class="v"><?php echo e($shipment->dispatch_date); ?></span></div>
                    <div class="summary-row"><span class="k">Payment Mode</span><span class="v"><span class="pay-badge"><?php echo e($shipment->payment_mode); ?></span></span></div>
                    <div class="summary-row"><span class="k">Total Amount Paid</span><span class="v amount"><?php echo e($settings->site_currency ?? '$'); ?><?php echo e(number_format($shipment->total_cost, 2)); ?></span></div>
                    <div class="summary-row"><span class="k">Mode of Transport</span><span class="v"><?php echo e($shipment->shipment_mode); ?></span></div>
                </div>
            </div>
            ...
            <div class="items">
                ...
                <table class="items-table">
                    ...
                    <tbody>
                        <?php $sn = 1; $items = $shipment->packageItems ?? collect(); ?>
                        <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="sn"><?php echo e($sn++); ?></td>
            ...
            <div class="invoice-foot">
                <div class="foot-box">
                    ...
                    <?php if(!empty($settings->payment_methods_image)): ?>
                        <img src="<?php echo e(asset($settings->payment_methods_image)); ?>" alt="Accepted payment methods">
                    <?php else: ?>
                        <span style="color:var(--muted); font-size:13px;">N/A</span>
                    <?php endif; ?>
                </div>
                <div class="foot-box" style="text-align:right;">
                    <h4>Official Stamp / <?php echo e($creationDate); ?></h4>
                    <?php if(!empty($settings->invoice_stamp)): ?>
                        <img class="stamp-img" src="<?php echo e(asset($settings->invoice_stamp)); ?>" alt="Official stamp">
                    <?php else: ?>
                        <span style="color:var(--muted); font-size:13px;">N/A</span>
                    <?php endif; ?>
                </div>
...
<?php /**PATH C:\wamp64\www\easyship\laravel\resources\views\print\invoice.blade.php ENDPATH**/ ?>