...
<?php $__env->startSection('title', 'Tracking Shipment'); ?>
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8">
                    <div class="track-no">
                        <h1>
                            ...
                            <span class="h1-actions">
                                <a href="<?php echo e(route('track')); ?>" class="thm-btn track-another-btn">
                                    <span class="txt"><i class="icon-next"></i>Track Another Shipment</span>
                                </a>
                                <a href="<?php echo e(route('track.print', $shipment->tracking_id)); ?>" target="_blank" class="thm-btn print-btn">
                                    <span class="txt">Print-Invoice</span>
                                </a>
                            </span>
                        </h1>
                        <strong style="font-size:18px;">Tracking No:</strong>
                        <strong style="font-size:22px; color:#C40202;"><?php echo e($shipment->tracking_id); ?></strong>
                    </div>
                    ...
                    <div style="display:flex; justify-content:flex-end; margin-bottom:10px;">
                        <button type="button" class="history-more-btn" id="history-more-btn" aria-expanded="false" aria-controls="history-list" data-old-count="<?php echo e($oldCount); ?>">
                            <span class="chev">&#9660;</span>
                            <span class="more-label">View Older Updates (<?php echo e($oldCount); ?>)</span>
                        </button>
                    </div>
                    <?php endif; ?>
                    <ul class="timeline-list" id="history-list">
                        <?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $isRecent = $index >= $history->count() - 5; ?>
                        <li class="<?php echo e($isRecent ? '' : 'history-item-old'); ?> <?php echo e(strtolower($h->status) === 'delivered' ? 'delivered' : ''); ?>">
                            <div class="tl-date">
                                <?php echo e(\Illuminate\Support\Carbon::parse($h->date)->format('F dS, Y')); ?>,
                                <?php echo e(\Illuminate\Support\Carbon::parse($h->time)->format('g:i A')); ?>

                            </div>
                            <div><strong><?php echo e($h->remarks); ?></strong><br><?php echo e($h->updated_by ?? ''); ?></div>
                            <div><?php echo e($h->location); ?></div>
                            <span class="tl-status"><?php echo e($h->status); ?></span>
                        </li>
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="track-side" style="text-align:center;">
                        <img class="pkg-img" src="<?php echo e($image_src); ?>" alt="Package Image">
                        <h3>Content of Shipment: <strong><?php echo e($shipment->package_discription); ?></strong></h3>
                    </div>

                    <div class="track-side">
                        <h3>Shipment Overview</h3>
                        <table>
                            <tr><th>Est. Delivery Date :</th><td><?php echo e($shipment->estimated_delivery_date); ?></td></tr>
                            <tr><th>Origin Area:</th><td><?php echo e($shipment->dispatch_location); ?></td></tr>
                            <tr><th>Destination Area:</th><td><?php echo e($shipment->destination); ?></td></tr>
                        </table>
                    </div>
                    ...
                    <div class="track-side">
                        ...
                        <table>
                            <tr><th>Name:</th><td><?php echo e($shipment->sender_name); ?></td></tr>
                            <tr><th>Email:</th><td><?php echo e($shipment->sender_email); ?></td></tr>
                            <tr><th>Address:</th><td><?php echo e($shipment->sender_address); ?></td></tr>
                        </table>
                    </div>
                    ...
                    <div class="track-side">
                        ...
                        <table>
                            <tr><th>Name:</th><td><?php echo e($shipment->receiver_name); ?></td></tr>
                            <tr><th>Email:</th><td><?php echo e($shipment->receiver_email); ?></td></tr>
                            <tr><th>Address:</th><td><?php echo e($shipment->receiver_address); ?></td></tr>
                        </table>
                    </div>
                </div>
            </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        const LOCATIONIQ_KEY = <?php echo json_encode($geocodeApiKey ?? '', 15, 512) ?>;
        const DEFAULT_CENTER = [9.0820, 8.6753];
        const DEFAULT_ZOOM = 6;

        const dispatchLabel = <?php echo json_encode($shipment->dispatch_location ?? '', 15, 512) ?>;
        const destinationLabel = <?php echo json_encode($shipment->destination ?? '', 15, 512) ?>;
        const shipmentHistory = <?php echo json_encode($shipment_history ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.subpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\easyship\laravel\resources\views/track-results.blade.php ENDPATH**/ ?>