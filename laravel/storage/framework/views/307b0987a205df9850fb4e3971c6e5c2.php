...
<?php $__env->startSection('content'); ?>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="site-settings" role="tabpanel" aria-labelledby="tab-site">
            <form method="POST" action="<?php echo e(route('admin.settings.site')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="site-name" value="<?php echo e(old('site-name', $settings->sitename)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Site Title</label>
                                <input type="text" class="form-control" name="site-title" value="<?php echo e(old('site-title', $settings->site_title)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Site URL</label>
                                <input type="url" class="form-control" name="site-url" value="<?php echo e(old('site-url', $settings->site_url)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Email Name (sender)</label>
                                <input type="text" class="form-control" name="email-name" value="<?php echo e(old('email-name', $settings->email_name)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Email Address</label>
                                <input type="email" class="form-control" name="email" value="<?php echo e(old('email', $settings->email_address)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Currency</label>
                                <input type="text" class="form-control" name="site_currency" value="<?php echo e(old('site_currency', $settings->site_currency)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Phone Number</label>
                                <input type="text" class="form-control" name="phone_number" value="<?php echo e(old('phone_number', $settings->phone_number)); ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Fax Number</label>
                                <input type="text" class="form-control" name="fax_number" value="<?php echo e(old('fax_number', $settings->fax_number)); ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Working Days</label>
                                <input type="text" class="form-control" name="working_days" value="<?php echo e(old('working_days', $settings->working_days)); ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Working Hours</label>
                                <input type="text" class="form-control" name="working_hours" value="<?php echo e(old('working_hours', $settings->working_hours)); ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Geocode API Key</label>
                                <input type="text" class="form-control" name="geocode_api_key" value="<?php echo e(old('geocode_api_key', $settings->geocode_api_key)); ?>">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" name="site_address" rows="3"><?php echo e(old('site_address', $settings->site_address)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            ?>
                            <?php $__currentLoopData = $imageFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inputName => [$label, $column]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label"><?php echo e($label); ?></label>
                                    <?php if($settings->{$column}): ?>
                                        <div class="mb-2">
                                            <img src="<?php echo e(asset($settings->{$column})); ?>" style="max-width:200px; max-height:100px;" class="rounded border">
                                            <div class="mt-1">
                                                <input type="hidden" name="remove_<?php echo e($column); ?>" id="remove_<?php echo e($column); ?>" value="0">
                                                <button type="button" class="btn btn-outline-danger btn-sm remove-image-btn" data-target="remove_<?php echo e($column); ?>">
                                                    <i class="bx bx-trash"></i> Mark image for removal
                                                </button>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    <input type="file" class="form-control" name="<?php echo e($inputName); ?>" accept="image/*">
                                </div>
        ...
        <div class="tab-pane fade" id="homepage-content" role="tabpanel" aria-labelledby="tab-home">
            <form method="POST" action="<?php echo e(route('admin.settings.homepage')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="hero_subtitle" value="<?php echo e(old('hero_subtitle', $settings->hero_subtitle)); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Hero Title</label>
                            <input type="text" class="form-control" name="hero_title" value="<?php echo e(old('hero_title', $settings->hero_title)); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Hero Text</label>
                            <textarea class="form-control" name="hero_text" rows="3"><?php echo e(old('hero_text', $settings->hero_text)); ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Video URL</label>
                            <input type="url" class="form-control" name="video_url" value="<?php echo e(old('video_url', $settings->video_url)); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Video Background Image</label>
                            <?php if($settings->video_bg_image): ?>
                                <div class="mb-2"><img src="<?php echo e(asset($settings->video_bg_image)); ?>" style="max-width:200px;" class="rounded border"></div>
                            <?php endif; ?>
                            <input type="file" class="form-control" name="video_bg_image" accept="image/*">
                            <input type="hidden" name="current_video_bg_image" value="<?php echo e($settings->video_bg_image); ?>">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <?php if($settings->home_banner_image): ?>
                                    <div class="mb-2">
                                        <img src="<?php echo e(asset($settings->home_banner_image)); ?>" style="max-width:100%; max-height:140px;" class="rounded border">
                                        <div class="mt-1">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <?php if($settings->page_banner_image): ?>
                                    <div class="mb-2">
                                        <img src="<?php echo e(asset($settings->page_banner_image)); ?>" style="max-width:100%; max-height:140px;" class="rounded border">
                                        <div class="mt-1">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" name="years_experience" value="<?php echo e(old('years_experience', $settings->years_experience)); ?>">
                            </div>
                            <?php for($n = 1; $n <= 4; $n++): ?>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Achievement <?php echo e($n); ?> Number</label>
                                    <input type="number" class="form-control" name="achievement_<?php echo e($n); ?>_num" value="<?php echo e(old('achievement_' . $n . '_num', $settings->{'achievement_' . $n . '_num'})); ?>">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Achievement <?php echo e($n); ?> Title</label>
                                    <input type="text" class="form-control" name="achievement_<?php echo e($n); ?>_title" value="<?php echo e(old('achievement_' . $n . '_title', $settings->{'achievement_' . $n . '_title'})); ?>">
                                </div>
                                <?php if($n == 4): ?>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Achievement 4 Suffix</label>
                                        <input type="text" class="form-control" name="achievement_4_suffix" value="<?php echo e(old('achievement_4_suffix', $settings->achievement_4_suffix)); ?>">
                                    </div>
                                <?php endif; ?>
                                <?php if($n < 4): ?>
                                    <div class="w-100"></div>
        ...
        <div class="tab-pane fade" id="email-settings" role="tabpanel" aria-labelledby="tab-email">
            <form method="POST" action="<?php echo e(route('admin.settings.email')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="smtp-host" value="<?php echo e(old('smtp-host', $settings->smtp_host)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">SMTP Port</label>
                                <input type="number" class="form-control" name="smtp-port" value="<?php echo e(old('smtp-port', $settings->smtp_port)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">SMTP Username</label>
                                <input type="text" class="form-control" name="smtp-username" value="<?php echo e(old('smtp-username', $settings->smtp_username)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">SMTP Password</label>
                                <div class="input-group">
                                    <input type="password" class="form-control" name="smtp-password" id="smtp-password" value="<?php echo e(old('smtp-password', $settings->smtp_password)); ?>" autocomplete="new-password">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" name="smtp-secure">
                                    ...
                                    <option value="tls" <?php echo e(old('smtp-secure', $settings->smtp_secure) == 'tls' ? 'selected' : ''); ?>>TLS</option>
                                    <option value="ssl" <?php echo e(old('smtp-secure', $settings->smtp_secure) == 'ssl' ? 'selected' : ''); ?>>SSL</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="email_name" value="<?php echo e(old('email_name', $settings->email_name)); ?>">
                                <small class="text-muted">Shown as the sender name on outgoing emails.</small>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">From Email</label>
                                <input type="email" class="form-control" name="email_address" value="<?php echo e(old('email_address', $settings->email_address)); ?>">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <?php if($settings->site_logo): ?>
                                    <div class="mb-2">
                                        <img src="<?php echo e(asset($settings->site_logo)); ?>" style="max-height:60px;" class="rounded border">
                                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="color" class="form-control form-control-color" name="email_primary_color" value="<?php echo e(old('email_primary_color', $settings->email_primary_color ?: '#041e42')); ?>" style="width:60px; height:38px;">
                                <small class="text-muted">Used for the email header background and highlights.</small>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label">Footer Text</label>
                                <textarea class="form-control" name="email_footer_text" rows="2"><?php echo e(old('email_footer_text', $settings->email_footer_text)); ?></textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-end">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control" name="test_email" id="test-email-input" value="<?php echo e(session('test_email_value', '')); ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" name="maintenance_mode" id="maintenance_mode" value="1" <?php echo e($settings->maintenance_mode ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="maintenance_mode">Enable Maintenance Mode</label>
                        </div>
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" name="search_engine_indexing" id="search_engine_indexing" value="1" <?php echo e((int)($settings->search_engine_indexing ?? 1) === 1 ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="search_engine_indexing">Allow Search Engine Indexing</label>
                        </div>
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" name="show_contact_map" id="show_contact_map" value="1" <?php echo e((int)($settings->show_contact_map ?? 1) === 1 ? 'checked' : ''); ?>>
...
<script>
    var anchor = <?php echo json_encode(session('anchor', ''), 512) ?>;
    if (anchor) {
    ...
    if (testBtn) {
        testBtn.addEventListener('click', function() {
            ...
            fetch('<?php echo e(route('admin.email.test-send')); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\easyship\laravel\resources\views\admin\settings.blade.php ENDPATH**/ ?>