...
@section('content')
    ...
    <section class="service-one">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 wow fadeInLeft" data-wow-delay="{{ $index * 200 }}ms" data-wow-duration="1500ms">
                    <div class="service-one__single">
                        <div class="service-one__single-icon-box">
                            ...
                            <div class="right-icon-box">
                                <a href="{{ route('services') }}"><span class="icon-next"></span></a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="about-one__img-box">
                        ...
                        <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <img src="{{ asset('assets/img/about/about-one__img1.jpg') }}" alt="#">
                        </div>
                        <div class="about-one__overlay-box text-center wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="outer-box">
                                <div class="count-outer count-box">
                                    <h2 class="odometer" data-count="{{ $settings->years_experience }}">00</h2>
                                    <i class="icon-add"></i>
                                </div>
                                <div class="title">
                ...
                <div class="col-xl-6">
                    <div class="about-one__content-box">
                        ...
                        <div class="text">
                            <p>At {{ $settings->sitename }}, we are more than just a courier service; we are your dedicated logistics partner. We understand that behind every package is a promise, a commitment, or a critical business need. That’s why we’ve built our reputation on a foundation of trust, reliability, and unparalleled customer service.</p>
                        </div>
                        <ul>
                            <li>
                                <div class="icon">
                ...
                <div class="fact-counter_box">
                    <ul class="clearfix">
                        <li class="single-fact-counter wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="outer-box">
                                <div class="count-outer count-box">
                                    <h2 class="odometer" data-count="{{ $settings->achievement_1_num }}">00</h2>
                                    <i class="icon-add"></i>
                                </div>
                                <div class="title"><p>{{ $settings->achievement_1_title }}</p></div>
                            </div>
                        </li>
                        <li class="single-fact-counter wow fadeInDown" data-wow-delay=".3s">
                            ...
                            <div class="outer-box">
                                <div class="count-outer count-box">
                                    <h2 class="odometer" data-count="{{ $settings->achievement_2_num }}">00</h2>
                                    <i class="icon-add"></i>
                                </div>
                                <div class="title"><p>{{ $settings->achievement_2_title }}</p></div>
                            </div>
                        </li>
                        <li class="single-fact-counter wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="outer-box">
                                <div class="count-outer count-box">
                                    <h2 class="odometer" data-count="{{ $settings->achievement_3_num }}">00</h2>
                                    <i class="icon-add"></i>
                                </div>
                                <div class="title"><p>{{ $settings->achievement_3_title }}</p></div>
                            </div>
                        </li>
                        <li class="single-fact-counter wow fadeInDown" data-wow-delay=".3s">
                            ...
                            <div class="outer-box">
                                <div class="count-outer count-box">
                                    <h2 class="odometer" data-count="{{ $settings->achievement_4_num }}">00</h2>
                                    @if(!empty($settings->achievement_4_suffix))<i class="k">{{ $settings->achievement_4_suffix }}</i>@endif
                                    <i class="icon-add"></i>
                                </div>
                                <div class="title"><p>{{ $settings->achievement_4_title }}</p></div>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".1s">
                            <div class="project-one__single">
                                <div class="project-one__single-img">
                                    <div class="inner">
                                        <img src="{{ asset('assets/img/project/project-one__img1.jpg') }}" alt="#">
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".1s">
                            <div class="project-one__single">
                                <div class="project-one__single-img">
                                    <div class="inner">
                                        <img src="{{ asset('assets/img/project/project-one__img2.jpg') }}" alt="#">
                                    </div>
                                </div>
                                <div class="project-one__single-content text-center">
                                    <div class="title-box">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".1s">
                            <div class="project-one__single">
                                <div class="project-one__single-img">
                                    <div class="inner">
                                        <img src="{{ asset('assets/img/project/project-one__img3.jpg') }}" alt="#">
                                    </div>
                                </div>
                                <div class="project-one__single-content text-center">
                                    <div class="title-box">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".1s">
                            <div class="project-one__single">
                                <div class="project-one__single-img">
                                    <div class="inner">
                                        <img src="{{ asset('assets/img/project/project-one__img4.jpg') }}" alt="#">
                                    </div>
                                </div>
                                <div class="project-one__single-content text-center">
                                    <div class="title-box">
    ...
    <section class="video-one">
        <div class="video-one__bg" data-jarallax data-speed="0.1" data-imgPosition="0% 0%"
            style="background-image: url({{ asset($settings->video_bg_image) }});"></div>
        <div class="icon wow zoomIn animated" data-wow-delay="300ms" data-wow-duration="1500ms">
            <a class="video-popup" title="Video Gallery" href="{{ $settings->video_url }}">
                            ...
                            <div class="testimonials-one__single">
                                ...
                                <div class="testimonials-one__single-content">
                                    <div class="ster-icon">
                                        ...
                                        <p>Reviews (0{{ $testimonial->rating }})</p>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="team-one__single">
                                <div class="team-one__single-img">
                                    ...
                                    <div class="social-share-box">
                                        ...
                                        <ul class="clearfix">
                                            @if(!empty($member->social_facebook))<li><a href="{{ $member->social_facebook }}"><i class="icon-facebook-app-symbol"></i></a></li>@endif
                                            @if(!empty($member->social_twitter))<li><a href="{{ $member->social_twitter }}"><i class="icon-twitter"></i></a></li>@endif
                                            @if(!empty($member->social_linkedin))<li><a href="{{ $member->social_linkedin }}"><i class="icon-linked-in-logo-of-two-letters"></i></a></li>@endif
                                            @if(!empty($member->social_pinterest))<li><a href="{{ $member->social_pinterest }}"><i class="icon-pinterest"></i></a></li>@endif
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="single-partner-logo-box">
                                <a href="#">
                                    <img src="{{ asset('assets/img/brand/brand-v1-' . $i . '.png') }}" alt="Awesome Image">
                                </a>
                            </div>
                        </div>
                        @endfor
