...
@section('title', ($settings->sitename ?? 'EasyShip') . ' | Contact')
                    ...
                    <div class="contact-one__list-item">
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="text">
                                    <h4>Lets Talk us</h4>
                                    <p>Phone number: <a href="tel:{{ $settings->phone_number }}">{{ $settings->phone_number }}</a></p>
                                    <p>Fax: <a href="tel:{{ $settings->fax_number }}">{{ $settings->fax_number }}</a></p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
