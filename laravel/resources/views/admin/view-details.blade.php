    ...
    <div class="card">
        <div class="card-body d-flex flex-wrap align-items-center justify-content-between">
            <div>
                ...
                <h1 class="text-primary mb-0">{{ $shipment->tracking_id }}</h1>
            </div>
            <div class="text-end">
        ...
        <div class="col-lg-4">
            @if($shipment->image)
                <div class="card">
                    <div class="card-body text-center">
                        <img src="{{ asset('uploads/' . $shipment->image) }}" alt="Package" class="img-fluid rounded">
                    </div>
                </div>
            @endif
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a class="btn btn-primary btn-sm w-100 mb-2" href="{{ route('admin.shipments.edit', $shipment->tracking_id) }}">
                        <i class="bx bx-edit"></i> Edit Shipment
                    </a>
                    <a class="btn btn-info btn-sm w-100" target="_blank"
                       href="{{ route('track.print', ['num' => $shipment->tracking_id]) }}">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $shipment->origin ?: 'N/A' }}" readonly>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $shipment->courier ?: 'N/A' }}" readonly>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $shipment->type_of_shipment ?: 'N/A' }}" readonly>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                       value="{{ $shipment->total_freight !== null ? ($settings->site_currency ?? '$') . number_format((float)$shipment->total_freight, 2) : 'N/A' }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Total Cost</label>
                                <input type="text" class="form-control"
                                       value="{{ ($settings->site_currency ?? '$') . number_format((float)$shipment->total_cost, 2) }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Date Added</label>
                                <input type="text" class="form-control" value="{{ $shipment->date_added ?: 'N/A' }}" readonly>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        @forelse($shipment->packageItems as $index => $item)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>{{ $item->quantity }}</td>
