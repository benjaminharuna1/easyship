...
@section('title', ($settings->sitename ?? 'EasyShip') . ' | Services')
    ...
    <section class="service-two service-two--service">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInLeft" data-wow-delay="{{ ($index % 3) * 200 }}ms" data-wow-duration="1500ms">
