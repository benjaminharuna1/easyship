                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="text" class="form-control" id="courier" name="courier" value="<?php echo htmlspecialchars($row['courier'] ?? ''); ?>">
                                                            </div>
                                                            <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="text" class="form-control" id="origin" name="dispatchlocation" value="<?php echo htmlspecialchars($row['dispatch_location'] ?? ''); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row mt-3">
                                                            <div class="col-md-4">
                                                                <label for="destination" class="form-label">Destination</label>
                                                                <input type="text" class="form-control" id="destination" name="destination" value="<?php echo htmlspecialchars($row['destination'] ?? ''); ?>">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="weight" class="form-label">Weight</label>
                                                                <input type="text" class="form-control" id="weight" name="weight" value="<?php echo htmlspecialchars($row['weight'] ?? ''); ?>">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="packages_count" class="form-label">Packages count</label>
                                                                <input type="number" class="form-control" id="packages_count" name="quantity" value="<?php echo htmlspecialchars($row['quantity'] ?? ''); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row mt-3">
                                                            <div class="col-md-8">
                                                                <label for="product_description" class="form-label">Product description</label>
                                                                <input type="text" class="form-control" id="product_description" name="packagedescription" value="<?php echo htmlspecialchars($row['package_discription'] ?? ''); ?>">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="total_freight" class="form-label">Total Freight</label>
                                                                <input type="text" class="form-control" id="total_freight" name="total_freight" value="<?php echo htmlspecialchars($row['total_freight'] ?? ''); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row mt-3">
                                                            <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="date" class="form-control" id="expected_delivery_date" name="estimateddeliverydate" value="<?php echo htmlspecialchars($row['estimated_delivery_date'] ?? ''); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row mt-3">
                                                            <div class="col-md-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="shipper_name" name="sendername" value="<?php echo htmlspecialchars($row['sender_name'] ?? ''); ?>">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="shipper_phone" class="form-label">Phone Number</label>
                                                            <input type="text" class="form-control" id="shipper_phone" name="sendercontact" value="<?php echo htmlspecialchars($row['sender_contact'] ?? ''); ?>">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="shipper_address" class="form-label">Address</label>
                                                            <input type="text" class="form-control" id="shipper_address" name="senderaddress" value="<?php echo htmlspecialchars($row['sender_address'] ?? ''); ?>">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="shipper_email" class="form-label">Email</label>
                                                            <input type="email" class="form-control" id="shipper_email" name="senderemail" value="<?php echo htmlspecialchars($row['sender_email'] ?? ''); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="receiver_name" name="receivername" value="<?php echo htmlspecialchars($row['receiver_name'] ?? ''); ?>">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="receiver_phone" class="form-label">Phone Number</label>
                                                            <input type="text" class="form-control" id="receiver_phone" name="receivercontact" value="<?php echo htmlspecialchars($row['receiver_contact'] ?? ''); ?>">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="receiver_address" class="form-label">Address</label>
                                                            <input type="text" class="form-control" id="receiver_address" name="receiveraddress" value="<?php echo htmlspecialchars($row['receiver_address'] ?? ''); ?>">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="receiver_email" class="form-label">Email</label>
                                                            <input type="email" class="form-control" id="receiver_email" name="receiver_email" value="<?php echo htmlspecialchars($row['receiver_email'] ?? ''); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
